...
class CreateOnboardingSchema(BaseModel):
    ...
    # For POST/create we accept minimal/optional nested objects so clients
    # don't need to supply internal IDs or full salary breakdowns.
    policies: Optional[PoliciesCreateSchema] = None
    offer_letter: Optional[OfferLetterCreateMinimal] = None
    salary_options: Optional[SalaryOptionsCreateMinimal] = None
